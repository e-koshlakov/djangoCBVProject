...
from users.views import user_register_view, user_login_view, user_profile_view, user_logout_view, user_udate_view, \
    user_change_password_view,  user_generate_new_password, UserRegisterView
